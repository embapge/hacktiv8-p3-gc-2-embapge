...
const (
	...
	PaymentService_GetByIDPayment_FullMethodName = "/payment.PaymentService/GetByIDPayment"
...
type PaymentServiceClient interface {
	...
	GetAllPayment(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListPaymentResponse, error)
	GetByIDPayment(ctx context.Context, in *PaymentIDRequest, opts ...grpc.CallOption) (*PaymentResponse, error)
	DeletePayment(ctx context.Context, in *PaymentIDRequest, opts ...grpc.CallOption) (*PaymentMessageResponse, error)
}
...
func (c *paymentServiceClient) GetAllPayment(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListPaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *paymentServiceClient) GetByIDPayment(ctx context.Context, in *PaymentIDRequest, opts ...grpc.CallOption) (*PaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentResponse)
...
func (c *paymentServiceClient) DeletePayment(ctx context.Context, in *PaymentIDRequest, opts ...grpc.CallOption) (*PaymentMessageResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentMessageResponse)
...
type PaymentServiceServer interface {
	...
	GetAllPayment(context.Context, *emptypb.Empty) (*ListPaymentResponse, error)
	GetByIDPayment(context.Context, *PaymentIDRequest) (*PaymentResponse, error)
	DeletePayment(context.Context, *PaymentIDRequest) (*PaymentMessageResponse, error)
...
func (UnimplementedPaymentServiceServer) GetAllPayment(context.Context, *emptypb.Empty) (*ListPaymentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllPayment not implemented")
}
func (UnimplementedPaymentServiceServer) GetByIDPayment(context.Context, *PaymentIDRequest) (*PaymentResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetByIDPayment not implemented")
}
func (UnimplementedPaymentServiceServer) DeletePayment(context.Context, *PaymentIDRequest) (*PaymentMessageResponse, error) {
...
func _PaymentService_GetAllPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetAllPayment(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_GetByIDPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetByIDPayment(ctx, req.(*PaymentIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_DeletePayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).DeletePayment(ctx, req.(*PaymentIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
